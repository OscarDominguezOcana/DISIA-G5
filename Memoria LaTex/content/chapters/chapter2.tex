...
La fuente de información que sustenta esta investigación es el conjunto de datos referenciado como \texttt{cupid\_algorithm\_dataset.csv}. Este \textit{dataset} emula el entorno operativo de una aplicación de emparejamiento (\textit{matchmaking}) a gran escala, registrando interacciones reales entre usuarios.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.60\textwidth]{Pictures/24_records_comp.png}
